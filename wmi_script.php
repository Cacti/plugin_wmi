 ...
 * a remote host (via the Linux_WMI wrapper around the wmic binary) and
 * either lists its index keys, prints an indexed key/value pair, or
 * returns a single fetched value, depending on $cmd. Called by Cacti's
 * script server (or directly from the CLI) when a Data Input Method
